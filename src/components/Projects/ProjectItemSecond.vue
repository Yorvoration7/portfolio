<template>
    <div class="my__projects container">
<div class="second__projects">
<a href="">
...
<p class="project__text">
    Project created by using framework Vue js, we can write any city name and then get info for a week.
</p>
<a href="">
...
.second__projects{
    ...
    align-items: center;
    width: 600px;
border: 2px solid rgb(7, 19, 43);; 
box-shadow: 0 0 15px rgb(255, 255, 255); 
border-radius: 50px 5px 50px 5px;
}

.project__title{
    color: rgb(255, 255, 255,0.870);
font-family: 'Poppins';
font-size: 36px;
font-weight: 600;
padding: 25px 225px;
...
.line{
  ...
  padding: 0 127px;
  /* margin-left: 127px; */
  background: linear-gradient(to right, rgba(19,173,199), rgb(97, 226, 23), rgb(148, 93, 214) , #00ffff, #0000ff, #ff00ff);
